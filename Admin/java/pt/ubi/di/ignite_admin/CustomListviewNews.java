...
public class CustomListviewNews extends ArrayAdapter<String> {
    ...
    public CustomListviewNews(Activity context, String[] name, String[] desc){
    ...
    public View getView(int position, @Nullable View convertView,@NonNull ViewGroup parent){
        ...
        while(cursor.moveToNext()){
            if(cursor.getString(0).equals(name[position])){ //Quando se encontrar a notícia pretendida
